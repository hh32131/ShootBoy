...
public interface Session {
	...
	public static final String SEARCH_TEAMBOARD_INFO= "_SEARCH_TEAMBOARD_INFO_";
	public static final String SEARCH_MATCH_INFO= "_SEARCH_MATCH_INFO_";
