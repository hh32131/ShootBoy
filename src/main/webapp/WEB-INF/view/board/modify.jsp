		...
		<div id="myPageLeftMenu">
			<div class="mplmTitle">Community</div>
				<div id="myPageLeftMenuTwo">
					...
					<div class="mplmFour"><c:if test="${categoryId eq 16}"><img src="/ShootBoy/img/화살표.jpg" class="arrow"></c:if><a href="/ShootBoy/list?categoryId=16">용병모집</a></div>
					...
					<div class="mplmFour"><c:if test="${categoryId eq 19}"><img src="/ShootBoy/img/화살표.jpg" class="arrow"></c:if><a href="/ShootBoy/list?categoryId=19">팀원모집</a></div>
				</div>
		</div>
		...
		<form id="modifyForm" name="modifyForm" enctype="multipart/form-data">
			...
			<div>
				<input type="text" id="boardSubject" name="boardSubject"
					placeholder="제목을 입력하세요." style="width:400px; height: 25px; font-size: 15px;"
					value="${board.boardSubject}" />
			</div>
			<div style="height: 10px;"></div>
			<div>
				<textarea id="boardContent" name="boardContent"
					placeholder="내용을 입력하세요." style="width:700px; height: 250px; 
					font-size: 15px; margin-bottom: 30px;">${board.boardContent}</textarea>
			</div>
