...
<body>
	<div id="userModifyWrapper">
		...
		<form id="userModifyForm" name="userModifyForm">
			...
			이름 <input type="text" id="userName" name="userName" value="${userInfo.userName}"> <br /><br/>
			비밀번호 <input type="text" id="password" name="password" value="${userInfo.password}"> <br /><br/>
			전화번호 <input type="text" id="phoneNumber" name="phoneNumber" value="${userInfo.phoneNumber}"><br /> <br/>
