...
<link rel="stylesheet" type="text/css" href="/ShootBoy/css/adminSignUp.css" />
	...
	<div id="wrapperSignUp">
		<form id="signUpForm" name="signUpForm">
			...
			아이디 <input type="text" id="email" name="email"
				placeholder="아이디를 입력하세요"><br /> 이름 <input type="text"
				id="userName" name="userName" placeholder="이름을 입력하세요"> <br />
			비밀번호 <input type="password" id="password1" name="password1"
				placeholder="비밀번호를 입력하세요"> <br /> 비밀번호 확인 <input
