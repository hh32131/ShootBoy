		...
		<form id="craeteTeamForm" name="createTeamForm"	enctype="multipart/form-data" >
			<div>
				<div class="inline-block" >
					<input type="text" style=" width: 255px; height: 25px;"	id="teamName" name="teamName" placeholder="팀명" />
				</div>
				<div class="inline-block">
					<input type="text" style=" width: 75px; height: 30px;" id="teamCount" name="teamCount" placeholder="팀원 수" />
				</div>
			</div>
		...
		<select name="leafLocation" id="leafLocation" >
			...
			<div>
				<textarea id="teamInfo" name="teamInfo"
					style="width: 350px; height: 250px;  font-size: 15px;" placeholder="소개글을 입력하세요."></textarea>
			</div>
