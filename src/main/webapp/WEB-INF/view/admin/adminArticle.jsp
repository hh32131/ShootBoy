						...
						<tr>
							<td class="td_check">
								<div class="checks check" id="checkBoard" neame="checkBoard">
									<input type="checkbox" class="select-check" data-selectid="${boards.boardId }" name="select-check" value="${boards.boardId }">
									<label for="select-check"></label>
								</div>
							</td>
							<c:set var="number" value="${fn:split(boards.boardId,'-')[2]}"/>
	                       	...
	                       	<td class="td_boardId" >
	                       		...
	                       		<span>
	                        		<a href="javascript:void(0)" class="boardCode" data-boardid="${boards.boardId }">
		                        		${number}
	                        		</a>	
	                       		</span>
	                       	</td>
							<td class="td_boardSubject">${boards.boardSubject} [${boards.replayHitCount}]</td>
