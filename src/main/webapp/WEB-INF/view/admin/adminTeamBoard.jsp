...
<script type="text/javascript">
	$().ready(function() {
		...
		$("#writeBtn").click(function() {
			window.open("/ShootBoy/adminTeamBoardWrite", "ADMINSIGNUP", "width=600, height= 600");
		});
	}); 
</script>
	...
	<div class="search-tool">
		<form id="searchForm" name="searchForm">
			...
			<input type="text" class="searchKeyword" name="searchKeyword"
				id="searchKeyword" value="${searchTeam.searchKeyword}" /> 
	...
	<div class="alldata-table">
		<table>
			...
			<form id="checkBoxForm" name="checkBoxForm">
				<c:forEach var="teamBoards" items="${teamBoards}">
					<tbody>
						<tr>
							<td class="td_check">
								<div class="checks check" id="checkBoard" name="checkBoard">
									<input type="checkbox" class="select-check"
										data-selectid="${teamBoards.teamBoardId }" name="select-check"
										value="${teamBoards.teamBoardId }"> 
